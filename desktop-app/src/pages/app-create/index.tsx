...
export const CreateApplication = () => {
    ...
    const isFormValid = () => {
        ...
        if (!formData.appName.trim()) {
            ...
            setNameError('Application name can only contain alphanumeric characters, hyphens, and underscores');
            isValid = false;
        } else {
            setNameError('');
        }
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center gap-2">
                                ...
                                <TooltipProvider>
                                    <Tooltip>
                                        ...
                                        <TooltipContent>
                                            <p>Your application will be created in: {formData.folderPath}/{formData.appName}</p>
                                        </TooltipContent>
                                    </Tooltip>
                                </TooltipProvider>
                            </div>
                            ...
                            {formData.folderPath && formData.appName && (
                                <p className="text-sm text-muted-foreground">
                                    Project will be created at: <span className="font-mono">{formData.folderPath}/{formData.appName}</span>
                                </p>
                            )}
                        </div>
