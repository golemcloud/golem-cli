...
vi.mock('@/components/golem-cli-path', () => ({
  GolemCliPathSetting: () => <div data-testid="golem-cli-path-setting">Golem CLI Path Setting</div>,
}));
...
describe('SettingsPage', () => {
  ...
  describe('Component Rendering', () => {
    ...
    it('should render the Golem CLI Path card', () => {
      ...
      expect(screen.getByText('Configure the path to the golem-cli executable')).toBeInTheDocument();
    });
  ...
  describe('Component Integration', () => {
    it('should properly integrate with the GolemCliPathSetting component', () => {
      ...
      expect(card).toContainElement(screen.getByTestId('golem-cli-path-setting'));
    });
  });
  ...
  describe('Accessibility', () => {
    it('should have proper heading structure', () => {
      ...
      expect(screen.getByRole('heading', { level: 2, name: 'Golem CLI Path' })).toBeInTheDocument();
    });
