...
describe('AppLayout', () => {
  ...
  describe('Suspense handling', () => {
    ...
    it('should show app id in the component', () => {
      ...
      expect(screen.getByTestId('navbar')).toBeInTheDocument();
      expect(screen.getByTestId('id-display')).toHaveTextContent('App ID: my-test-app');
    });
  ...
  describe('Route parameter handling', () => {
    it('should extract id parameter correctly', () => {
      ...
      expect(screen.getByTestId('test-id')).toHaveTextContent('my-specific-app-123');
    });
    ...
    it('should handle special characters in app id', () => {
      ...
      expect(screen.getByTestId('test-id')).toHaveTextContent('app-with-dashes_and_underscores');
    });
  ...
  describe('Component structure', () => {
    it('should render components in correct order', () => {
      ...
      expect(screen.getByTestId('error-boundary')).toContainElement(screen.getByTestId('navbar'));
  ...
  describe('Nested routes', () => {
    it('should handle nested route structures', () => {
      const NestedChild = () => <div data-testid="nested-child">Nested Component</div>;
    ...
    it('should handle nested routes with parameter access', () => {
      ...
      expect(screen.getByTestId('nested-param')).toHaveTextContent('ID: test-id');
    });
  });
