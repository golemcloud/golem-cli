...
describe('RibEditor', () => {
  ...
  describe('Basic rendering', () => {
    it('should render RibEditor with default props', () => {
      ...
      expect(screen.getByTestId('monaco-editor')).toHaveAttribute('data-language', 'rib');
    });
    ...
    it('should render with custom value', () => {
      ...
      expect(screen.getByTestId('monaco-editor')).toHaveAttribute('data-value', testValue);
    });
  ...
  describe('Language configuration', () => {
    ...
    it('should set language configuration for RIB', () => {
      ...
      expect(mockMonaco.languages.setLanguageConfiguration).toHaveBeenCalledWith('rib', {
        comments: {
          lineComment: '//',
          blockComment: ['/*', '*/'],
        },
    ...
    it('should set Monarch tokens provider for RIB syntax highlighting', () => {
      ...
      expect(mockMonaco.languages.setMonarchTokensProvider).toHaveBeenCalledWith('rib', expect.objectContaining({
        defaultToken: '',
        tokenPostfix: '.rib',
  ...
  describe('Theme management', () => {
    it('should define dark theme when Monaco is available', () => {
      ...
      expect(mockMonaco.editor.defineTheme).toHaveBeenCalledWith('rigDarkTheme', expect.objectContaining({
        base: 'vs-dark',
        inherit: true,
    ...
    it('should define light theme when Monaco is available', () => {
      ...
      expect(mockMonaco.editor.defineTheme).toHaveBeenCalledWith('rigLightTheme', expect.objectContaining({
        base: 'vs',
        inherit: true,
        rules: expect.arrayContaining([
          { token: 'namespace', foreground: '8A2BE2' },
    ...
    it('should use light theme when theme is light', () => {
      ...
      expect(screen.getByTestId('monaco-editor')).toHaveAttribute('data-theme', 'rigLightTheme');
    });
    ...
    it('should use dark theme when theme is dark', () => {
      ...
      expect(screen.getByTestId('monaco-editor')).toHaveAttribute('data-theme', 'rigDarkTheme');
    });
  ...
  describe('Completion provider', () => {
    it('should register completion item provider for RIB', () => {
      ...
      expect(mockMonaco.languages.registerCompletionItemProvider).toHaveBeenCalledWith('rib', expect.objectContaining({
        triggerCharacters: expect.arrayContaining(['.', 'r', 'e', 'q', 'u', 'e', 's', 't', 'v', 'a', 'r']),
  ...
  describe('Editor options', () => {
    ...
    it('should not set readOnly when disabled prop is false', () => {
      ...
      expect(screen.getByTestId('monaco-editor')).toHaveAttribute('data-readonly', 'false');
    });
  ...
  describe('Accessibility', () => {
    it('should have proper container structure', () => {
      ...
      expect(container.firstChild).toHaveClass('relative', 'rounded-md', 'border', 'p-2');
    });
  });
});