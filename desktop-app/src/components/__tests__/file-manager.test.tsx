...
vi.mock('@/components/ui/collapsible', () => ({
    ...
    CollapsibleTrigger: ({ children, style, className }: any) => (
        <button data-testid="collapsible-trigger" style={style} className={className}>
            {children}
        </button>
    ),
}));
...
describe('FolderStructure', () => {
    ...
    describe('Edge cases', () => {
        ...
        it('should handle long file and folder names', () => {
            ...
            expect(screen.getByText('very-long-folder-name-that-might-overflow')).toBeInTheDocument();
            expect(screen.getByText('extremely-long-file-name-with-many-characters.extension')).toBeInTheDocument();
        });
        ...
        it('should handle special characters in names', () => {
            ...
            expect(screen.getByText('folder with spaces & symbols!')).toBeInTheDocument();
            expect(screen.getByText('file-with-dashes_and_underscores.txt')).toBeInTheDocument();
        });
