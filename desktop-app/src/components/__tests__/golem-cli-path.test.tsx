...
describe('GolemCliPathSetting', () => {
  ...
  describe('Basic rendering', () => {
    it('should render all components correctly', () => {
      ...
      expect(screen.getByText(/Specify the path to the golem-cli executable/)).toBeInTheDocument();
    });
    ...
    it('should have correct input attributes', () => {
      ...
      expect(input).toHaveAttribute('placeholder', 'Select golem-cli executable path');
  ...
  describe('Initial loading', () => {
    it('should load existing golem-cli path on mount', async () => {
      mockSettingsService.getGolemCliPath.mockResolvedValue('/existing/path/to/golem-cli');
    ...
    it('should handle loading errors gracefully', async () => {
      mockSettingsService.getGolemCliPath.mockRejectedValue(new Error('Load error'));
      ...
      await waitFor(() => {
        expect(consoleSpy).toHaveBeenCalledWith('Error loading golem-cli path:', expect.any(Error));
      });
  ...
  describe('Browse functionality', () => {
    ...
    it('should handle browse errors', async () => {
      ...
      await waitFor(() => {
        expect(consoleSpy).toHaveBeenCalledWith('Error selecting golem-cli path:', expect.any(Error));
  ...
  describe('Save functionality', () => {
    it('should save path when save button is clicked', async () => {
      ...
      await waitFor(() => {
        expect(mockSettingsService.setGolemCliPath).toHaveBeenCalledWith('/path/to/golem-cli');
        expect(mockToast).toHaveBeenCalledWith({
    ...
    it('should handle save errors', async () => {
      ...
      await waitFor(() => {
        expect(consoleSpy).toHaveBeenCalledWith('Error saving golem-cli path:', expect.any(Error));
        expect(mockToast).toHaveBeenCalledWith({
    ...
    it('should handle save promise rejection', async () => {
      const user = userEvent.setup();
      mockSettingsService.setGolemCliPath.mockRejectedValue(new Error('Save failed'));
