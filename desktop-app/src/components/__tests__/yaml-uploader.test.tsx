...
vi.mock("react-router-dom", async () => {
  ...
  return {
    ...
    useParams: vi.fn(),
    useSearchParams: () => [
      new URLSearchParams("?path=/test&method=GET&reload=true"),
    ],
  };
});
...
describe("YamlUploader", () => {
  ...
  describe("File upload", () => {
    it("should handle invalid YAML file", async () => {
      ...
      const file = new File(["invalid: yaml: content"], "test.yaml", {
  ...
  describe("YAML validation", () => {
    ...
    it("should validate CORS preflight binding", async () => {
      ...
      expect(
        screen.getByText(/Missing 'component' for 'cors-preflight'/),
      ).toBeInTheDocument();
    });
  });
